...
class Home_Page : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var type=typeSpinner.selectedItem as Type
        ...
        clearFoodButton?.setOnClickListener {
            ...
            foodSuggestionEditText.text.toString()==""
        }
...
//        }
        ...
        generateFoodButton?.setOnClickListener {
            ...
            when {
                type == Type.Breakfast && timeEditText.text.toString() == "Light" -> food =
                    "You may have:\n\n" +
                ...
                type == Type.Breakfast && timeEditText.text.toString() == "Heavy" -> food =
                    "You may have:\n\n " +
                            "Tomato and Feta Baked Eggs\n" + "Scrambled Eggs with smoked Trout and Crème Fraiche\n" +
                            "Customizable Egg Muffins\n" + "Sweet Potato Breakfast Burritos\n" + "Cornflakes\n"

                type == Type.Lunch && timeEditText.text.toString() == "Light" -> food =
                ...
                type == Type.Lunch && timeEditText.text.toString() == "Heavy" -> food =
                    "You may have:\n\n" +
                            "Sweet Potato and Peanut curry\n" + "Pepper  Steak Pie\n" + "Fish Pie Mac n Cheese\n" +
                            "Sausage ragu\n" + "Spicy chickpea stew\n"

                type == Type.Dinner && timeEditText.text.toString() == "Light" -> food =
                    "You may have:\n\n" +
                ...
                type == Type.Dinner && timeEditText.text.toString() == "Heavy" -> food =
                    "You may have:\n\n" +
                            "" + "" + "" + "" + ""
            }
        }
